...
$sso_xmlrpc = new GD_Reseller_System_Plugin_Sso_Xmlrpc();
$sso_xmlrpc->set_sso_auth_filter_priority( 21 );
$sso_xmlrpc->set_api( $gd_api );

$ga_xmlrpc = new MT_System_Plugin_Google_Analytics_Xmlrpc();
...
function activate_mtsp() {
    add_option('mtsp_web_property_id_head', null);
    add_option('mtsp_web_property_id_footer', null);
}
