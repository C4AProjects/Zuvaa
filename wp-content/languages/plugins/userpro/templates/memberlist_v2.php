	...
	<div class="userpro-body userpro-body-nopad">
		...
		<div class="userpro-awsm">
			...
			<div class="userpro-awsm-pic">
				...
				<a href="<?php echo $userpro->profile_photo_url($user_id); ?>" class="userpro-tip-fade lightview" data-lightview-caption="<?php echo $userpro->profile_photo_title( $user_id ); ?>" title="<?php _e('View member photo','userpro'); ?>"><?php echo get_avatar( $user_id, $memberlist_v2_pic_size ); ?></a>
				<?php } else { ?>
