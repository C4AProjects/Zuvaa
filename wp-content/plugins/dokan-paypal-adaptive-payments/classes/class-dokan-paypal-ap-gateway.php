    ...
    function process_payment( $order_id ) {
        ...
        if ( $sub_orders ) {
            ...
            foreach ( $sub_orders as $key => $order_post ) {
                ...
                $seller_pay_email = dokan_get_seller_withdraw_mail( dokan_get_seller_id_by_order( $order_post->ID ) );
            ...
            $seller_balance   = $this->get_seller_net_balance( $order_id, dokan_get_seller_id_by_order( $order_id ) );
