	...
	wp_nonce_field('woowaitlist-update-settings'); ?>
		...
		switch( $current_tab ){
			case "woowaitlist_settings":
				...
				$wew_out_of_stock_str = get_option('wew-out-of-stock-str') ? get_option('wew-out-of-stock-str') : __('Out of stock', $plugin_slug );
				...
				$based_on_subscription = get_option('wew-based-on-subscription') ? get_option('wew-based-on-subscription') : 'stock_status' ;
				...
				<form method="post" action="<?php echo $current_tabURL_slug; ?>" class="woowaitlist-settings-form">
					...
					<div class="woowaitilist-sw">
						<label><?php _e('Out of stock', $plugin_slug ); ?></label>&nbsp;
						<input type="text" name="wew-out-of-stock-str" id="wew-out-of-stock-str" value="<?php echo $wew_out_of_stock_str; ?>" />
					</div>
					...
					<div class="woowaitilist-sw">
						<label for="wew-based-on-subscription"><?php _e('Display subscribe field based on:', $plugin_slug ); ?></label>&nbsp;
						
						<select name="wew-based-on-subscription" id="wew-based-on-subscription">
							<option value=""<?php if( $based_on_subscription == 'stock_status' ){ echo ' selected="selected"'; } ?>><?php _e('Stock status', $plugin_slug ); ?></option>
							<option value="quantity"<?php if( $based_on_subscription == 'quantity' ){ echo ' selected="selected"'; } ?>><?php _e('Managed stock quantity', $plugin_slug ); ?></option>							
						</select>
					</div>
			...
			case "email_settings":
				...
				$custom_sender_email_address = get_option('notifications-sender-email') ? get_option('notifications-sender-email') : get_option('woocommerce_email_from_address') ;
